...
Unlike most workflow managers, `drake` focuses on your R session, so it does not care how you organize your files. This flexibility is great in the long run, but it leaves many new users wondering how to structure their projects. This chapter aims to fill in guidance and advice.
