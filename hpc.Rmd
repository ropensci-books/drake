...
<span style = "color: red;">**We emphasize: in hasty mode, the [core reproducibility of `drake`](https://ropensci.github.io/drake/#evidence) are no longer valid. Here, `drake` cannot provide evidence that your results are synchronized with the underlying code and data.** Hasty mode should only be used for debugging and testing or if computional reproducibility is handled some other way.</span>
...
> _The fastest code is the code you do not run_.

#### Specific usage concerns
