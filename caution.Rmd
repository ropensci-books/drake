...
It is common practice to divide the work of a project into multiple R files, but if you do this, you will not get the most out of `drake`. Please see the [best practices chapter](#practices) for more details.
...
See the [best practices guide](#practices) and `?expose_imports` for detailed explanations. Thanks to [Jasper Clarkberg](https://github.com/dapperjapper) for the workaround.
