...
The following scenarios are fairly typical:
...
`drake`'s data recovery feature tries to solve these problems. See the [walkthrough chapter](#walkthrough) for details.
