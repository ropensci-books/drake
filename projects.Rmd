...
When it comes to plans, use *functions* instead. As of `drake` version `7.6.2.9000`, there is a function called `code_to_function()` that will assist in moving your scripts based workflow into a `drake` plan. 
...
good_plan <- drake_plan(
  ...
  my_summaries = do_summary(my_analysis)
)
