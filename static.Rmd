...
The forward propagation of grouping variables is powerful, but it can easily go wrong. Rules:

1. Define each grouping variable only once.
2. Explicitly inherit grouping variables from targets that use them.
