...
See the [best practices vignette](https://github.com/ropensci/drake/blob/master/vignettes/best-practices.Rmd) and `?expose_imports` for detailed explanations. Thanks to [Jasper Clarkberg](https://github.com/dapperjapper) for the workaround.
