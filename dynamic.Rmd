...
To make things easier to manage, we should develop and test on a downsized version of the workflow before scaling up. Simply set `max_expand` to a small number in `make()`.
