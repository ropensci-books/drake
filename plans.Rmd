...
Symbols passed with explicit argument names define new groupings of existing targets on the fly, and only the `map()` and `cross()` transformations can accept them this ways. These new groupings carry over to subsequent transformations in the plan.
