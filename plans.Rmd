...
With the exception of `.tag_in` and `.tag_out` (more on that later) a grouping variables is an argument to `map()`, `cross()`, or `reduce()`. Grouping variables can be literals or symbols, and grouping symbols can be passed as named or unnamed arguments. 
