...
`drake` provides several older utility that increase the flexibility of plan creation. They may go away at some point in the future, they are still officially supported at this point.

- [`map_plan()`](https://ropensci.github.io/drake/reference/map_plan.html)
- [`evaluate_plan()`](https://ropensci.github.io/drake/reference/evaluate_plan.html)
- [`expand_plan()`](https://ropensci.github.io/drake/reference/expand_plan.html)
- [`gather_by()`](https://ropensci.github.io/drake/reference/gather_by.html)
- [`reduce_by()`](https://ropensci.github.io/drake/reference/reduce_by.html)
- [`gather_plan()`](https://ropensci.github.io/drake/reference/gather_plan.html)
- [`reduce_plan()`](https://ropensci.github.io/drake/reference/reduce_plan.html)
