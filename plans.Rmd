...
For more customization, you can construct sections of the plan in stages, combine the sections together, and then transform at the very end. This sort of preprocessing tends to rely on `drake_plan(trace = TRUE)`, which retains provenance information generated during the transformation process.
