...
```{r transform9, eval = FALSE}
f <- function(x, y, ...) {
  this_call <- match.call(expand.dots = FALSE)
  print(this_call)
  print(mode(this_call))
  print(typeof(this_call))
  print(as.character(this_call$x))
  print(all.vars(this_call$y))
  print(as.character(this_call$...$z))
}
```
