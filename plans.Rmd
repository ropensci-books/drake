...
As we saw in our [previous example](#hpc), repeated `make()`s skip work that is already up to date. To skip steps, we need to know what those steps actually are. Workflow plan data frames formally enumerate these steps, whereas scripts and notebooks do not.
