...
- `trigger`: choose the criterion that `drake` uses to decide whether to build the target. See `?trigger` or read the chapter of this manual on triggers to learn more.
