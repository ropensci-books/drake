...
By default, the commands are [language objects](http://adv-r.had.co.nz/Expressions.html). You can turn `plan$command` into a character if you want, but this is not recommended.

```{r firstexampleplan2}
str(plan$command)

text <- unname(purrr::map_chr(plan$command, rlang::expr_text))
# Optional: plan$command <- text
