...
In `combine()`, you can replace symbols in a command with collections of other targets. You must tell `combine()` about the grouping variables (e.g. `data`) and grouping functions (e.g. `bind_rows()`) in the transformation.
