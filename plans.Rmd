...
Here, `drake_slice()` takes a single subset of the data at runtime. It supports lists, vectors, data frames, matrices, and arbitrary arrays, and you can subset on any margin (rows, columns, etc).
