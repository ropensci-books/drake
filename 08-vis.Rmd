...
It is often useful to construct static non-interactive graphs to save plot files, construct reproducible examples, etc. Use `static_drake_graph()` to produce a [`ggplot2`](https://ggplot2.tidyverse.org/)/[`ggraph`](https://github.com/thomasp85/ggraph) version of your graph, which you can then augment with further layers, plot in your console, or save with `ggsave()`.
