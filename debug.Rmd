...
To tailor these settings to each individual target, create new `timeout`, `cpu`, `elapsed`, or `retries` columns in your `drake` plan. These columns override the analogous arguments to `make()`.
