...
produce later on. We refer to these as targets.
You can declare targets in any order and drake will figure out the order of 
execution.
...
Note that creating the plan does not run any of
the code in the `command` column, that will only happen when you call `make()`
on the plan.
