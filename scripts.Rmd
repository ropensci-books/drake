...
imperative scripts. Many such projects are already too big and cumbersome to
seriously refactor. The purpose of `code_to_function()` is to quickly and 
painlessly allow `drake` to accommodate these situations.
